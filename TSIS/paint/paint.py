...
# Tools that use click-drag-release (not handled in MOUSEMOTION)
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if text_tool.active:
                    ...
                    if text_tool.confirmed:
                        ...
                        text_tool.reset()
                    # (cancelled is handled inside handle_key → reset())
                    continue          # skip all other key logic
                ...
                # Tool shortcuts (S key is square, not save here)
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                # Click on palette strip → pick colour
                if my < 40:
